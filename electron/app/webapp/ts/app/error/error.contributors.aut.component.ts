...
namespace app.error {
  ...
  */
  class ErrorContributorsAutController {
    ...
    /**
    * @type {Object} selectedItemAut - Almacena la información de la celdas que
  ...
  app.component("errorContributorsAut", {
    bindings: {
      selectedItemAut: "=",
      ...
      errorsFilter: "=",  // Filtro para incluir solo los errores corregibles ya aplicados
    ...
    templateUrl: "./components/error/error.contributors.aut.html"
  });
}
